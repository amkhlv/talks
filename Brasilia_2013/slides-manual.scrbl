...
@hyperlink["http://planet.racket-lang.org/package-source/amkhlv/bystroTeX.plt/6/0/planet-docs/manual/index.html"]{manual page}.
...
@verb|{
<formula size="25" filename="formulas/3.png"> \sum_{n&gt;0} {x^n\over n} </formula>
}|
--- this is called ``@hyperlink["http://en.wikipedia.org/wiki/XML"]{XML}''
}
